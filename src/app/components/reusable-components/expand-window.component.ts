...
@Component({
    ...
    template: `
        ...
        <div class="row d-flex align-items-center expand-section">
            <div class="col">
                <span (click)="onWindowHandler()" class="lead cursor-pointer">            
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-plus-circle-dotted mb-1 me-1" viewBox="0 0 16 16">
