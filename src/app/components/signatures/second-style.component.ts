...
@Component({
    ...
    template: `
        ...
        <div class="signatureBox">
            <table #secondSignature cellspacing="0" cellpadding="4" style="background-color: white; border-collapse: collapse; line-height: 1.3;">
                <tr *ngIf="!withoutLogo">
                    <td>
                ...
                <tr>
                    <td style="font: {{titleFontSize}}px {{ passSelectedFont() }}; color: {{textBColour}}; letter-spacing: 0.4pt;">
                ...
                <tr>
                    ...
                    <td *ngIf="lineSeparator" style="padding: 15px 0px 15px 5px;">
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr>
                                <td width="{{lineWidth}}" style="margin: 0.1px; padding: 0px; border-top: 2px solid {{textAColour}};"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
